...
pub use item_groups::{
    ITEM_GROUP_DRESSING_MARKER_PREFIX, ITEM_TEMPERATURE_NORMAL_AMBIENT_MILLIKELVIN,
    ITEM_TEMPERATURE_PROCESS_INTERVAL_TICKS, ITEM_TEMPERATURE_UNPROCESSED_ENERGY_MJ_PER_G,
    ITEM_TEMPERATURE_UNPROCESSED_MILLIKELVIN, InclusiveI32RangeV1, InclusiveU16RangeV1,
    ...
    SPAWN_POCKET_SINGLE_ITEM_MARKER, decode_item_group_dressing_marker,
    encode_item_group_dressing_marker, initial_item_temperature_state,
    is_reserved_item_group_dressing_marker, item_description_expansion_is_valid,
