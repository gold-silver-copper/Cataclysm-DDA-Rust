...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 127
/// added resolved effect modifiers and monster multi-strike profiles.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 105;
