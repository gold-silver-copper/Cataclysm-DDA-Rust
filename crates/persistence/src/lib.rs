...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 105
/// retained production monster ordinary-combat profiles in the worldgen
/// catalog. Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 83;
