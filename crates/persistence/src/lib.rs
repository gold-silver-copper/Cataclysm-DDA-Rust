...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 103
/// retained the authoritative medical-item catalog. Metadata-only databases
/// may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 81;
