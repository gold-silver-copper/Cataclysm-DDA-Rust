...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 123
/// added polymorph profiles and authoritative transform events.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 101;
