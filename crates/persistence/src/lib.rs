...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 89
/// added canonical item-description snippet expansion plans.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 67;
