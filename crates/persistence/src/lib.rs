...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 122
/// added canonical monster firing-mode identities and burst counts.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 100;
