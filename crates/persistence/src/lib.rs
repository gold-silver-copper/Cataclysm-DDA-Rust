...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 120
/// added canonical monster-gun targeting profiles and targeting events.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 98;
