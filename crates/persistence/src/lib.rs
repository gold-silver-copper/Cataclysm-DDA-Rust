...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 121
/// added canonical data-driven monster projectile-effect profiles.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 99;
