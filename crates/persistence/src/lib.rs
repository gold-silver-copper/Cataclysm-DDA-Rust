...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 128
/// added spell field profiles and signed persistent field ages.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 106;
