...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 104
/// retained production monster armor in the worldgen catalog. Metadata-only
/// databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 82;
