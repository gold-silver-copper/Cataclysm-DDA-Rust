...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 117
/// retained canonical monster-alpha EOC effects and variables.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 95;
