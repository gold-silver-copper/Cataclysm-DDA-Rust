...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 124
/// added target-context EOC conditions and effects.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 102;
