...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 130
/// added canonical authoritative NPC dialogue, faction, mission, and mapgen state.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 108;
