...
/// Old Postcard snapshots and journals cannot be decoded after Protocol 142
/// added stable mission assignment order.
/// Metadata-only databases may still migrate.
pub const MIN_RECOVERABLE_SCHEMA_VERSION: i64 = 119;
